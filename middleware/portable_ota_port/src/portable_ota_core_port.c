...
static const pota_compat_text_entry_t s_product_error_texts[] = {
    {OTA_ERR_NONE, "NONE"},
    {OTA_ERR_BUSY, "BUSY"},
    {OTA_ERR_INVALID_STATE, "INVALID_STATE"},
    {OTA_ERR_IMAGE_TOO_LARGE, "IMAGE_TOO_LARGE"},
    {OTA_ERR_BAD_HEADER, "BAD_HEADER"},
    {OTA_ERR_BOARD_MISMATCH, "BOARD_MISMATCH"},
    {OTA_ERR_VERSION_REJECTED, "VERSION_REJECTED"},
    {OTA_ERR_FLASH_ERASE, "FLASH_ERASE"},
    {OTA_ERR_FLASH_PROGRAM, "FLASH_PROGRAM"},
    {OTA_ERR_READBACK, "READBACK"},
    {OTA_ERR_CRC, "CRC"},
    {OTA_ERR_VECTOR, "VECTOR"},
    {OTA_ERR_METADATA, "METADATA"},
    {OTA_ERR_ABORTED, "ABORTED"},
    {OTA_ERR_BOOT_ROLLBACK, "BOOT_ROLLBACK"},
    {OTA_ERR_QUEUE_FULL, "QUEUE_FULL"},
    {OTA_ERR_BAD_ARGUMENT, "BAD_ARGUMENT"},
    {OTA_ERR_SIGNATURE_INVALID, "SIGNATURE_INVALID"},
    {OTA_ERR_SECURITY_COUNTER_ROLLBACK, "SECURITY_COUNTER_ROLLBACK"},
};
...
static const pota_compat_map_entry_t s_product_error_aliases[] = {
    ...
    {POTA_ERR_FLASH_ERASE, OTA_ERR_FLASH_ERASE},
    {POTA_ERR_FLASH_PROGRAM, OTA_ERR_FLASH_PROGRAM},
    {POTA_ERR_READBACK, OTA_ERR_READBACK},
    {POTA_ERR_CRC, OTA_ERR_CRC},
    {POTA_ERR_VECTOR, OTA_ERR_VECTOR},
    {POTA_ERR_METADATA, OTA_ERR_METADATA},
    {POTA_ERR_ABORTED, OTA_ERR_ABORTED},
    {POTA_ERR_BAD_ARGUMENT, OTA_ERR_BAD_ARGUMENT},
    {POTA_ERR_SIGNATURE_INVALID, OTA_ERR_SIGNATURE_INVALID},
    {POTA_ERR_SECURITY_COUNTER_ROLLBACK, OTA_ERR_SECURITY_COUNTER_ROLLBACK},
};
