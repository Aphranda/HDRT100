...
static tdma_rx_scan_t s_tdma_rx_scan_preparation;
...
bool tdma_runtime_owner_init(void)
{
    ...
    if (slots != NULL &&
        ...
        s_tdma_pio_spi_phys.rx_scan_preparation = &s_tdma_rx_scan_preparation;
...
{
    return s_tdma_runtime_owner_initialized &&
        tdma_pio_spi_phys_origin_get_reference_epoch(&s_tdma_pio_spi_phys, epoch);
}
