...
uint s_tdma_pio_spi_flight_origin_clock_offset;
uint s_tdma_pio_spi_flight_origin_data_offset;
uint s_tdma_pio_spi_flight_data_capture_offset;
uint s_tdma_pio_spi_flight_data_follower_offset;
uint s_tdma_pio_spi_flight_process_follower_offset;
uint s_tdma_pio_spi_flight_control_forward_offset;
uint s_tdma_pio_spi_flight_clock_latch_offset;
uint s_tdma_pio_spi_flight_origin_rtt_offset;
...
{
    return s_tdma_pio_spi_marker_rx;
}
...
/* Persona loaders below own all PIO program installation and removal. */

/* Flight persona loaders are implemented in tdma_pio_spi_phys_persona.c. */

/* Flight origin loader moved to tdma_pio_spi_phys_persona.c. */

/* Flight follower loader moved to tdma_pio_spi_phys_persona.c. */

/* Process-follower loader moved to tdma_pio_spi_phys_persona.c. */

/* P3 initiator loader moved to tdma_pio_spi_phys_persona.c. */

/* P3 responder loader moved to tdma_pio_spi_phys_persona.c. */

/* P3 reference loader moved to tdma_pio_spi_phys_persona.c. */

/* Persona dispatch moved to tdma_pio_spi_phys_persona.c. */

/* Persona unload moved to tdma_pio_spi_phys_persona.c. */

/* Persona selection moved to tdma_pio_spi_phys_persona.c. */

/* Physical setup helpers moved to tdma_pio_spi_phys_setup.c. */
...
/* Flight setup/recovery moved to tdma_pio_spi_phys_setup.c. */
...
static bool tdma_pio_spi_phys_cal_persona_switch_ready(void)
{
    if (tdma_pio_spi_phys_is_flight_persona()) {
        ...
        return tdma_pio_spi_phys_flight_sms_claimed() &&
