...
/* SRAM-only bounded LIVE permission; true/zero means inactive, false keeps out. */
bool tdma_pio_spi_phys_origin_get_reference_epoch(const tdma_pio_spi_phys_t *phys,
    uint32_t *epoch);
