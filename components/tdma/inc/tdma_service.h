...
typedef struct {
    ...
    uint32_t ring_clock_observation_valid;
    uint32_t ring_clock_observation_node_count;
    uint32_t ring_clock_observation_source_node;
    uint32_t ring_clock_observation_reference_node;
    uint32_t ring_clock_observation_sequence;
    uint32_t ring_clock_observation_frame_crc32;
    uint32_t ring_clock_observation_schedule_crc32;
    ...
    uint32_t ring_clock_local_rx_timestamp_ns_hi;
...
typedef enum {
    ...
    TDMA_SERVICE_FLIGHT_MAP_INVALID = 1u,
    TDMA_SERVICE_FLIGHT_MAP_SNAPSHOT_UNAVAILABLE = 2u,
    TDMA_SERVICE_FLIGHT_MAP_RUNTIME_ACTIVE = 3u,
    TDMA_SERVICE_FLIGHT_MAP_BUSY = 4u,
    TDMA_SERVICE_FLIGHT_MAP_ENGINE_ACTIVE = 5u,
} tdma_service_flight_map_result_t;
