...
#define OTA_SLOT_MANIFEST_LANE_SIZE      FLASH_DEPLOYMENT_GEOMETRY_ERASE_SIZE
#define OTA_SLOT_MANIFEST_BASE_OFFSET(slot) \
    (FLASH_DEPLOYMENT_MAP_OTA_STAGE_OFFSET + FLASH_DEPLOYMENT_MAP_OTA_STAGE_SIZE - \
     (slot == OTA_SLOT_A ? 4u : 2u) * OTA_SLOT_MANIFEST_LANE_SIZE)
#define OTA_SLOT_MANIFEST_LANE_BYTES     (2u * OTA_SLOT_MANIFEST_LANE_SIZE)
