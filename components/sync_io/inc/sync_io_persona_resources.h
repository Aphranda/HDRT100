...
/* Board RS485 retains 0/1; RUN/capture use 2/3; TDMA owns 4..8. */
#define SYNC_IO_REFERENCE_POP_DMA_CH 9u
#define SYNC_IO_REFERENCE_STAMP_DMA_CH 10u
#define SYNC_IO_REFERENCE_DMA_MASK \
    ((1u << SYNC_IO_REFERENCE_POP_DMA_CH) | \
     (1u << SYNC_IO_REFERENCE_STAMP_DMA_CH))
...
#define SYNC_IO_LOGIC_ANALYZER_INSTRUCTION_WORDS 5u
...
typedef enum {
    ...
    SYNC_IO_PERSONA_ID_REFERENCE_MONITOR,
