...
#define CALIBRATION_CLK_MARKER_FAULT_IDLE_HIGH (1u << 2u)
#define CALIBRATION_CLK_MARKER_FAULT_DATA_ALL \
    (CALIBRATION_CLK_MARKER_FAULT_EPOCH_OVERRIDE | \
     CALIBRATION_CLK_MARKER_FAULT_HEADER_CRC8_XOR)
#define CALIBRATION_CLK_MARKER_FAULT_MARKER_ALL \
    CALIBRATION_CLK_MARKER_FAULT_IDLE_HIGH
#define CALIBRATION_CLK_MARKER_FAULT_ALL \
    (CALIBRATION_CLK_MARKER_FAULT_DATA_ALL | \
     CALIBRATION_CLK_MARKER_FAULT_MARKER_ALL)
