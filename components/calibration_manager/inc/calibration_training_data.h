...
#define CALIBRATION_TRAINING_DATA_FAULT_WIRE_EPOCH_OVERRIDE (1u << 0u)
#define CALIBRATION_TRAINING_DATA_FAULT_WIRE_HEADER_CRC8_XOR (1u << 1u)
#define CALIBRATION_TRAINING_DATA_FAULT_PIO_STALL (1u << 2u)
#define CALIBRATION_TRAINING_DATA_FAULT_DMA_OVERRUN (1u << 3u)
#define CALIBRATION_TRAINING_DATA_FAULT_WIRE_ALL \
    (CALIBRATION_TRAINING_DATA_FAULT_WIRE_EPOCH_OVERRIDE | \
     CALIBRATION_TRAINING_DATA_FAULT_WIRE_HEADER_CRC8_XOR)
#define CALIBRATION_TRAINING_DATA_FAULT_TRANSPORT_ALL \
    (CALIBRATION_TRAINING_DATA_FAULT_PIO_STALL | \
     CALIBRATION_TRAINING_DATA_FAULT_DMA_OVERRUN)
#define CALIBRATION_TRAINING_DATA_FAULT_ALL \
