...
static uint32_t calibration_clk_marker_half_chip_samples(uint8_t codebook_id)
{
    ...
    case CALIBRATION_CLK_CODEBOOK_M255_MANCHESTER_24:
        return CALIBRATION_CLK_MARKER_HALF_CHIP_SAMPLES_24NS;
    case CALIBRATION_CLK_CODEBOOK_M255_MANCHESTER_32:
        return CALIBRATION_CLK_MARKER_HALF_CHIP_SAMPLES_32NS;
    default:
        return 0u;
    }
}
