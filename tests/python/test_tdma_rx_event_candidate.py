...
int main(void) {
    ...
    tdma_pio_spi_event_recovery_snapshot_t recovery;
    memset(&recovery, 0xa5, sizeof(recovery));
    const tdma_pio_spi_event_recovery_snapshot_t unchanged_recovery = recovery;
    assert(!tdma_pio_spi_phys_event_recovery_get(&phys, &recovery));
