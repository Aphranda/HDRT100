...
@pytest.mark.parametrize("case", ["quality_snapshot", "stopped_configuration", "diagnostic_burst", "stopped_update", "writer", "changed", "window", "miss", "abort", "resident", "map_admission", "lifecycle", "lifecycle_selected", "lifecycle_pending"])
