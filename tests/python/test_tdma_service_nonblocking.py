...
@pytest.mark.parametrize("case", ["diagnostic_burst", "stopped_update", "writer", "changed", "window", "miss", "abort", "resident", "map_admission", "lifecycle", "lifecycle_selected", "lifecycle_pending"])
