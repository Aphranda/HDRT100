...
typedef enum {
    ...
    POTA_BOOT_RESULT_SLOT_RANGE_INVALID,
    POTA_BOOT_RESULT_VECTOR_INVALID,
    POTA_BOOT_RESULT_IMAGE_CRC_INVALID,
    POTA_BOOT_RESULT_IMAGE_HASH_INVALID,
    POTA_BOOT_RESULT_SIGNATURE_INVALID,
    POTA_BOOT_RESULT_COMPATIBILITY_INVALID,
    POTA_BOOT_RESULT_RECOVERY_UNAVAILABLE,
    POTA_BOOT_RESULT_SLOT_EMPTY,
} pota_boot_result_t;
