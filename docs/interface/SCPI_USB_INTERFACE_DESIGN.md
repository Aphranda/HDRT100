...
Status: Active
Domain: USB
Canonical: `docs/interface/SCPI_USB_INTERFACE_DESIGN.md`
Related: `docs/interface/SCPI_COMMANDS.md`, `docs/arch/HAOFV_ARCHITECTURE.md`, `docs/ota/OTA_HAOFV_ARCHITECTURE.md`
