...
Related: `docs/sync/SYNC_IO_RESOURCE_PLAN.md`, `docs/sync/SYNC_IO_REFACTOR_PLAN.md`, `docs/interface/SCPI_COMMANDS.md`, `docs/arch/RTOS_PORTING_PLAN.md`, `docs/arch/RTOS_DISTRIBUTED_TRIGGER_PARTITION.md`, `docs/arch/MULTICORE_PARTITION_PLAN.md`
