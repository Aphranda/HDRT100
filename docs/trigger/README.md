...
Related: `docs/README.md`, `docs/arch/RTOS_DISTRIBUTED_TRIGGER_PARTITION.md`, `docs/docs/DOCS_DOMAIN_STRUCTURE_PLAN.md`
...
| `../sync/SYNC_IO_RESOURCE_PLAN.md` | PIO、GPIO、DMA 和语义 IO 资源规划 |
