...
Status: Active
Domain: OTA
Canonical: `docs/OTA_PORTABLE_ARCHITECTURE.md`
Related: `docs/OTA_SYSTEM_DESIGN.md`, `docs/OTA_LIBRARY_MIGRATION_PLAYBOOK.md`, `docs/OTA_OPEN_SOURCE_COMPARISON.md`
