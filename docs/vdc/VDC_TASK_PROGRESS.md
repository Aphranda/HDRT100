...
历史事件桥仍是工作区与 `out/` 冻结快照，尚未纳入该代码提交；其中历史桥当前
工作区指纹为 `9b255ffdaf82158a695fc112840eddb7a97093b718c0202e594f6c637443b7ce`。
...
回归已完成，见 `VDC-PROGRESS-20260916-031`；下一步接入现有 Core0 缓存和同事件
配对，尚未接通从板 DCO，不再重跑 P0T 寻优。
