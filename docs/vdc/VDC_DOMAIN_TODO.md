...
`VDC_DPLL_STATUS_REVIEW.md`；波动围绕自身中心进入 ±50 ns，不等于跨启动相对 NO1
全部进入 ±50 ns。FPGA 纯硬件与 ps 量级属于后续平台演进，不纳入本阶段退出门禁。
...
最新证据见 `VDC-PROGRESS-20260918-048`；不继续扩大旧
