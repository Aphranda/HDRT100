...
下一步收敛物理首事件、packet/event 身份与 DMA anchor 的证明边界，并分别追踪
startup、普通计数/persona 和严格校准失败；不得把候选 sequence 相等或完整诊断
记录提升为正式时间戳。自主总门禁、身份
和物理精度仍未闭合，`VDC-TIME-003/004` 不开放。证据见
`VDC-PROGRESS-20260915-001/003/004/005/006/007/008/009/010`；OTA 保持现状。
