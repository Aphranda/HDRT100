# 相控阵测试系统分布式触发方案 0614 摘要

Status: Active
Domain: RTOS
Canonical: `docs/RTOS_DISTRIBUTED_TRIGGER_0614_SUMMARY.md`
Related: `docs/RTOS_DISTRIBUTED_TRIGGER_0614_REPORT.html`, `docs/RP2350B_FOUR_BOARD_DISTRIBUTED_TRIGGER_SCHEME.md`, `docs/SYNC_IO_DISTRIBUTED_DPLL_DESIGN.md`
