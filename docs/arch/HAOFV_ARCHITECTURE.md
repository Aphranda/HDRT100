...
| `VDC-BOUNDARY-01` | 特等席固定配额承载逐从本地服务边界频率命令；Core0 在原有效期内有界重复同命令，Core1 连续应用、精确 ACK 退休及至多一次，显式单次诊断不授予锁相 | `docs/vdc/VDC_DOMAIN_ARCHITECTURE.md:VDC-BOUNDARY-01` | pending |
