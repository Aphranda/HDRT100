...
| `VDC-PRIORITY-01` | 独立 typed 同步邮箱携带完整事件/运行代际和 output-ns 区间；Core1 编码，TDMA owner 双缓冲提交，RX IRQ 在普通队列之前同步交接定长解码入口；匹配、DCO、单圈期限及锁相分别验收 | `docs/vdc/VDC_DOMAIN_ARCHITECTURE.md:VDC-PRIORITY-01` | pending |
