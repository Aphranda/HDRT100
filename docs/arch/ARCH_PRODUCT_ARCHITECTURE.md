...
Related: `docs/arch/HAOFV_ARCHITECTURE.md`, `docs/arch/HAOFV_VDC_DPLL_ARCHITECTURE.md`, `docs/arch/RTOS_HAOFV_ARCHITECTURE.md`, `docs/arch/ARCH_FUTURE_APPLICATION_PLAN.md`, `docs/trigger/TRIGGER_SYNC_TODO.md`, `docs/sync/SYNC_IO_ARCHITECTURE.md`, `docs/ota/OTA_HAOFV_ARCHITECTURE.md`, `docs/storage/SD_TODO.md`, `docs/storage/LOG_SYSTEM_TODO.md`, `docs/trigger/TRIGGER_FOUR_BOARD_DISTRIBUTED_PLAN.md`
...
| PIO/GPIO/AUX 资源约束 | `docs/sync/SYNC_IO_ARCHITECTURE.md` |
| 四板业务拓扑 | `docs/trigger/TRIGGER_FOUR_BOARD_DISTRIBUTED_PLAN.md` |
| VDC/DPLL 核心架构 | `docs/arch/HAOFV_VDC_DPLL_ARCHITECTURE.md` |
| DPLL/虚拟 DC 落地方案 | `docs/sync/SYNC_IO_ARCHITECTURE.md` |
| OTA/Bootloader | `docs/ota/OTA_HAOFV_ARCHITECTURE.md` |
...
| PinProbe A1 历史 RamVector | `docs/legacy/pinprobe/LEGACY_PINPROBEA1_RAM_REFLECTIVE_MEMORY_ARCHITECTURE.md` |
