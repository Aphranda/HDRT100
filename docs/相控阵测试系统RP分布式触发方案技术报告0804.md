...
Related: `docs/RTOS_DISTRIBUTED_TRIGGER_0804_REPORT.html`, `docs/RTOS_DISTRIBUTED_TRIGGER_PARTITION.md`, `docs/trigger/RP2350B_FOUR_BOARD_DISTRIBUTED_TRIGGER_SCHEME.md`
