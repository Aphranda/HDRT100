...
Status: Frozen
Domain: TDMA
Canonical: `docs/legacy/tdma/LEGACY_TDMA_DOMAIN_ARCHITECTURE.md`
...
> 历史快照：保留重构前正文及其中的候选方案、旧部署与单次实测。不作为当前实现或契约事实源；当前入口为 `docs/tdma/TDMA_DOMAIN_ARCHITECTURE.md`，任务状态见对应 TODO。
