...
Status: Frozen
Domain: TDMA
Canonical: `docs/legacy/tdma/LEGACY_TDMA_TASK_PROGRESS_01.md`
...
> 历史 ID 勘误：原 `TDMA-TASK-20260819-002` 同时指向 EtherCAT flight 与 COM3 单板两条不同记录；后者仅标题改为 `TDMA-TASK-20260819-004`，正文逐字保留。
...
### TDMA-TASK-20260819-004 - COM3 单板 TDMA 闭环烧录与训练验证
