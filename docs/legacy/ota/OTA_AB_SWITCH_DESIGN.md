...
Status: Deprecated
Domain: OTA
Canonical: `docs/legacy/ota/OTA_AB_SWITCH_DESIGN.md`
Related: `docs/ota/OTA_HAOFV_ARCHITECTURE.md`, `docs/ota/OTA_TODO.md`, `docs/legacy/ota/OTA_COPY_TRANSACTION_DESIGN.md`
