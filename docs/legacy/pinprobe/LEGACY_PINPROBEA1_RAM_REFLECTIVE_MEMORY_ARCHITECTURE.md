...
Related: `docs/arch/RTOS_HAOFV_ARCHITECTURE.md`, `docs/arch/HAOFV_ARCHITECTURE.md`, `docs/legacy/pinprobe/LEGACY_PINPROBEA1_OTA_CAN_DISTRIBUTION_ARCHITECTURE.md`
