...
Related: `docs/sync/SYNC_IO_RESOURCE_PLAN.md`, `docs/trigger/TRIGGER_SYNC_TODO.md`, `docs/arch/RTOS_HAOFV_ARCHITECTURE.md`
Last updated: 2026-07-07

本文档把 0614 分布式触发完整报告中的 DPLL、未来预约触发和反馈校准思想，收敛为当前 RP2350_TRIG 工程可以分阶段落地的多板原型方案。当前 RTOS + 双核 AMP 入口见 `docs/arch/RTOS_HAOFV_ARCHITECTURE.md`。
