...
Status: Active
Domain: SYNC_IO
Canonical: `docs/sync/SYNC_IO_REFACTOR_PLAN.md`
Related: `docs/sync/SYNC_IO_RESOURCE_PLAN.md`, `docs/communication/BISSC_SYNC_IO_PERIPHERAL_CIRCUIT_DESIGN.md`, `docs/trigger/TRIGGER_SYNC_TODO.md`
...
- 调试 LOG 遵循 `docs/storage/LOG_SYSTEM_TODO.md`：只记录低频生命周期和可恢复异常，
