...
Related: `docs/reports/distributed-trigger/相控阵测试系统RP分布式触发方案技术报告0804.html`, `docs/arch/RTOS_HAOFV_ARCHITECTURE.md`, `docs/trigger/TRIGGER_FOUR_BOARD_DISTRIBUTED_PLAN.md`
...
- `docs/trigger/TRIGGER_FOUR_BOARD_DISTRIBUTED_PLAN.md`
