...
| 路径 | 定位 |
|---|---|
| `scpi/RP1200波导天线测试系统分布式触发方案SCPI指令表.html` | 产品级 SCPI 指令表 HTML 输出 |
| `scpi/RP1200波导天线测试系统分布式触发方案SCPI指令表.pdf` | 产品级 SCPI 指令表 PDF 输出 |
...
- 报告输出文件可用于打印、归档和交付。
- 产品源文档优先从 `docs/interface/`、`docs/arch/`、`docs/trigger/` 等业务域维护。
