...
Related: `docs/HAOFV_ARCHITECTURE.md`, `docs/RTOS_DISTRIBUTED_TRIGGER_PARTITION.md`, `docs/TRIGGER_SYNC_TODO.md`, `docs/SYNC_IO_RESOURCE_PLAN.md`, `docs/ota/OTA_SYSTEM_DESIGN.md`, `docs/storage/SD_TODO.md`, `docs/storage/LOG_SYSTEM_TODO.md`, `docs/RP2350B_FOUR_BOARD_DISTRIBUTED_TRIGGER_SCHEME.md`
...
| 触发域待办与当前基线 | `docs/TRIGGER_SYNC_TODO.md` |
