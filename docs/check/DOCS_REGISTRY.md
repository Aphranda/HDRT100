...
| VDC-PRIORITY-01 | vdc | 固定 typed 同步邮箱、output-ns 区间与非复用运行代际；Core1 事件编码并由 TDMA owner 直接双缓冲提交，普通工位不可覆盖，不授予 DCO/锁相 | 1 | docs/vdc/VDC_DOMAIN_ARCHITECTURE.md:VDC-PRIORITY-01 | vdc_priority_tx.inc | codec/运行绑定/STOP/普通隔离 host、目标资源、匹配源码四板 P3 与 typed 接收专项 | 2026-09-17 | pending |
