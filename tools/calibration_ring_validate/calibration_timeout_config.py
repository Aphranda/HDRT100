...
Short command acknowledgement waits are separate from phase completion bounds.
Each entrypoint still exposes CLI overrides, while this table keeps defaults
consistent across the calibration flow.
"""
