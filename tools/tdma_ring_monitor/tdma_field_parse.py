...
FIELDS = [
    ...
    "ring_clock_observation_correlation_flags",
    "ring_clock_reference_tx_phase_ns",
    "ring_clock_local_rx_phase_ns",
    "ring_clock_common_effective_time_ns_lo",
    "ring_clock_common_effective_time_ns_hi",
